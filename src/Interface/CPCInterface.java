 ...
 * @author vitorcasadei
 */
public class CPCInterface extends javax.swing.JFrame {

    /**
     * Creates new form CPCInterface
     */
    public CPCInterface(String folder) {
        setVisible(true);
        initComponents();
        if(!folder.isEmpty()){
    ...
    private void initComponents() {
        ...
        ProjFoldertf = new javax.swing.JTextField();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Execute CPC");
        ...
        jLabel1.setText("Execute CPC at Folder:");
        ...
        Tcb.setText("-t");
        Tcb.setToolTipText("-t");

        Pcb.setText("-p");
        Pcb.setToolTipText("-p");

        jLabel2.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(1, 1, 1));
        jLabel2.setText("Select the execution options:");
        ...
        jLabel4.setText("Insert project folder name:");

        ProjFoldertf.setForeground(new java.awt.Color(1, 1, 1));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(ProjFoldertf, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(9, 9, 9)
                .addComponent(ProjFoldertf, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void OKbtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OKbtMouseClicked
        ...
        if(!ProjFoldertf.getText().equals("")){
            proj = ProjFoldertf.getText();
        } else {
            ProjFoldertf.setBorder(BorderFactory.createLineBorder(Color.red));
            isOK = false;
        }
        ...
        if(isOK){  
            ...
            if(retorno.isEmpty()){
                ...
                this.dispose();
                ErrorMessage error = new ErrorMessage("CPC", retorno);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CPCInterface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CPCInterface("").setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField ProjFoldertf;
    private javax.swing.JButton SelectFolderbt;
    private javax.swing.JCheckBox Tcb;
