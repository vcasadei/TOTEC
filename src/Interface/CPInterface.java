 ...
 * @author vitorcasadei
 */
public class CPInterface extends javax.swing.JFrame {

    /**
     * Creates new form CPCInterface
     */
    public CPInterface(String folder) {
        setVisible(true);
        initComponents();
        if(!folder.isEmpty()){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Execute CP at Folder:");
    ...
    private void OKbtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OKbtMouseClicked
        ...
        if(isOK){  
            String retorno = "";
            retorno = CP.main(new String[]{folder, proj, 
                    parameter});
            if(retorno.isEmpty()){
                this.dispose();
                SuccessMessage ok = new SuccessMessage("CP");
            } else {
                this.dispose();
                ErrorMessage error = new ErrorMessage("CP", retorno);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CPInterface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CPInterface("").setVisible(true);
            }
        });
    }
